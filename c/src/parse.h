 ...
 *    considering sentences are separated by periods ('.'). Therefore, any endline character ('\n')
 ...
 *    between them.
 *  - Each of the output lines has to end in a newline character ('\n').
 *
 ...
 *  single file at #INPUTS_PATH (named like this because these files will be used as an input
 *  to a Python script).
 *
