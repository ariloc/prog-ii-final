 ...
 *
 *  <b>Must be the name of a file to be created in the same directory as the executable.</b>
 *
 *  @see TEXTS_PATH
 */
 ...
 *
 *  @param filesListPath Path of a file where the list of the files in a folder is written.
 */
 ...
 *
 *  As such, the file at @p filesListPath may not be created or modified (if it already exists)
 *  in case of failure of the commands aforementioned (i.e. any of the paths isn't accessible 
 *  or doesn't exist).
 *
...
/**
 *  Given a path to a directory, prepends it to each of the @p n filenames listed in 
 *  @p filenames.
 *
 *  @param directory Path of a directory which will be prepended to the beginning of the filenames.
